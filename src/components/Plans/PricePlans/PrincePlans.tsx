import { MotionTrasition } from "@/components/MotionTransition/MotionTrasition";
import { dataPricePlans } from "./PrincesPlans.data";
import { PricesPlansProps } from "./PrincesPlans.types";

export function PrincePlans(props: PricesPlansProps) {
